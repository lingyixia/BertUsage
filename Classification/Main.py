...
parser = argparse.ArgumentParser(description="Bert分类Demo")
...
class MyTextClassification(run_classifier.DataProcessor):
    def get_labels(self):
        return ["SYS_NONE_ATTITUDE", "SYS_YES", "SYS_NO"]
    ...
    def _create_examples(self, lines, set_type):
        ...
        for (i, line) in enumerate(lines):
            ...
            examples.append(run_classifier.InputExample(guid=guid, text_a=text_a, label=label))
        return examples
...
if __name__ == '__main__':
    ...
    myTextClassification = MyTextClassification()
